...
class Single extends React.Component {
  ...
  src(){
    if(this.state.beer.labels.large){return true}
    else{return false}
  }
  render() {
    ...
    // const large = this.src()
    const a = (typeof beer.labels.large == undefined)?false:true
    return (
      <div>
        ...
        <div className="single-beer">
          ...
          <img className="label" src={a?beer.labels.large:null} alt={beer.name}/>
          <div className="style">
